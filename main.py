...
def prediction():
    ...
    if class_predictions[0]==1:
            st.success(str("Probably the train will arrive late "+str(class_predictions_proba[0][1]*100)[:5]))        
    else:
            st.success(str("Probably the train will arrive in time "+str(class_predictions_proba[0][0]*100)[:5]))   
    ...
    if class_predictions[0]==0:
            st.success(str("Probably the train will arrive in time "+str(class_predictions_prob[0][0]*100)[:5]))        
    elif class_predictions[0]==1:
            st.success(str("Probably the train delay is short (between 0 and 5 minutes) "+str(class_predictions_proba[0][1]*100)[:5]))   
    else:
            st.success(str("Probably the train delay is long (more than 5 minutes) "+str(class_predictions_proba[0][2]*100)[:5]))              
